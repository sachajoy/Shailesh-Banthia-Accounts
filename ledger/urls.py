...
urlpatterns = [
    ...
    path('ledger/<int:client_id>',
         ...
         name='ledger-client'),
    path('print/client/<int:client_id>/ledger/<int:trancation_id>/<int:logo>/<int:name>/<int:period>/<int:booking>/<int:firm>/<int:firm_show>/',
    ...
    path('all-trancations/', tranction_view.TrancationListView.as_view(), name='all-trancations'),
     path('update-trancation/<int:pk>',
         tranction_view.TrancationUpdateView.as_view(),
         name='update-trancation'),
]
